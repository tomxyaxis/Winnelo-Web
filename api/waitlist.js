        ...
        <table width="560" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;border-radius:4px;max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 40px 0;">
              ...
              <p style="color:#94a3b8;font-size:12px;letter-spacing:0.2px;margin:8px 0 28px;">The competitive learning platform built around friendly competition.</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f3f7ff;border-radius:4px;border:1px solid rgba(0,71,171,0.15);margin:0 0 28px;">
                <tr>
                  <td style="padding:20px 24px;">
                    ...
                    <p style="color:#1a1c1c;font-size:15px;line-height:24px;margin:0 0 16px;">A learning platform where you tailor the level of competition to fit your culture. Design and schedule challenges to reinforce knowledge at the perfect time.</p>
                    <p style="color:#64748b;font-size:14px;line-height:22px;margin:0 0 4px;">→&nbsp; Get started in minutes</p>
                    <p style="color:#64748b;font-size:14px;line-height:22px;margin:0 0 4px;">→&nbsp; AI-generated questions from your own content</p>
                    <p style="color:#64748b;font-size:14px;line-height:22px;margin:0 0 4px;">→&nbsp; Real-time leaderboards with team interaction</p>
                    <p style="color:#64748b;font-size:14px;line-height:22px;margin:0;">→&nbsp; Reporting and knowledge gap tracking</p>
                  </td>
                </tr>
              </table>
